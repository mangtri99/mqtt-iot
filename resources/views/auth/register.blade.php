            ...
            <div class="col-lg-6 col-md-8">
                <div class="card bg-secondary shadow border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="text-center text-muted mb-4">
                            <p class="text-muted">Sistem Monitoring Kesehatan Berbasis IoT</p>
                            <h3 class="text-muted">{{ __('REGISTER') }}</h3>
                        </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-6 text-right">
                        <small class="text-light">Sudah punya akun?</small>
                        <a href="{{ route('login') }}">
                            <small>{{ __('Login Disini') }}</small>
                        </a>
                    </div>
                </div>
            </div>
